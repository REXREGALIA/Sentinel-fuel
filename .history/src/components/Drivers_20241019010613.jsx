        ...
        <div className="bg-gray-800 rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredDrivers.map((driver) => (
              <div key={driver.id} className="bg-gray-700 rounded-lg p-6 shadow-md hover:shadow-lg transition duration-300">
                <h3 className="text-xl font-semibold mb-2 text-gray-100">{driver.name}</h3>
                ...
                <div className="flex justify-end space-x-2 mt-4">
                  <button onClick={() => handleEdit(driver)} className="p-2 bg-blue-600 text-blue-100 rounded hover:bg-blue-700 transition duration-300">
                    <Edit size={18} />
                  </button>
                  <button onClick={() => handleDelete(driver.id)} className="p-2 bg-red-600 text-red-100 rounded hover:bg-red-700 transition duration-300">
                    <Trash2 size={18} />
                  </button>
                </div>
              </div>
