...
import { X, User, Truck, Settings, LogOut, GasStation } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col space-y-8 text-xl">
          ...
          <NavLink icon={<GasStation size={20} />} text="Add Petrol Pump" to="/home" />
          <NavLink icon={<Truck size={20} />} text="Add Trucks" to="/trucks" />
