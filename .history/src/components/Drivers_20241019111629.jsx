...
export default function Drivers() {
  ...
  <form onSubmit={handleSubmit} className="space-y-4">
    ...
    <div className="space-y-2">
      <label htmlFor="licenseNumber" className="block text-lg font-medium text-gray-300">License Number</label>
      <input
        type="text"
        id="licenseNumber"
        name="licenseNumber"
    ...
    <div className="space-y-2">
      <label htmlFor="image" className="block text-lg font-medium text-gray-300">Driver Image</label>
      <div className="flex items-center justify-start">
        ...
        <label
          htmlFor="image"
          className=" flex justify-start px-4 py-2 bg-blue-500 text-white rounded-md cursor-pointer hover:bg-blue-600 transition duration-200"
        >
          Choose File
        </label>
        {formData.image && (
          <img src={formData.image} alt="Preview" className=" mx-4 w-16 h-16 object-cover rounded-full" />
        )}
      </div>
    </div>
    <div className="space-y-2">
      <label htmlFor="contactNumber" className="block text-lg font-medium text-gray-300">Contact Number</label>
      <input
        type="tel"
        id="contactNumber"
        name="contactNumber"
    ...
    <div className="space-y-2">
      <label htmlFor="currentLocation" className="block text-lg font-medium text-gray-300">Current Location</label>
      <input
        type="text"
        id="currentLocation"
    ...
    <div className="space-y-2">
      <label htmlFor="fuelInTank" className="block text-lg font-medium text-gray-300">Fuel in Tank (L)</label>
      <input
        type="number"
        id="fuelInTank"
        name="fuelInTank"
