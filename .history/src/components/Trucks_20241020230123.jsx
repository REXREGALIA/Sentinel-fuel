...
export default function Trucks() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error('An error occurred while adding/updating the truck. Please try again.')
    }
    setIsLoading(false)
  }
  ...
  const handleDeleteClick = async (truck) => {
    if (true) {
      ...
      try {
        ...
        toast.error('An error occurred while deleting the truck. Please try again.')
      }
      setIsLoading(false)
      setOpenMenu(null)
    }
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-start">
                          ...
                          {formData.image && (
                            <img src={formData.image} alt="Preview" className="w-16 h-16 mx-5 object-cover rounded-full border-2 border-blue-400" />
                          )}
                        </div>
                      </div>
                      <button
                  ...
                  <div key={truck.id} className="flex flex-col items-center bg-gray-800 p-4 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-1 relative">
                    ...
                    <div className="absolute top-2 right-2">
                      <button
                        ...
                        className="p-1 rounded-full hover:bg-gray-600 transition duration-300"
                      >
