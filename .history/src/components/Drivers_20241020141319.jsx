        ...
        {drivers.map((driver) => (
          <div key={driver.driverId} className="flex flex-col items-center">
            <button
              ...
              className="driver-image-container relative w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden hover:ring-4 hover:ring-blue-500 transition duration-300"
            >
