  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen flex">
      ...
      <motion.nav
        ...
        className={`fixed top-0 left-0 bottom-0 w-64 bg-gray-800 p-6 flex flex-col z-50 lg:relative lg:translate-x-0 lg:w-64 lg:flex ${sidebarOpen ? '' : 'hidden'} lg:block`}
      >
