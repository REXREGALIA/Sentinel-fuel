      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        {trucks.map((truck) => (
          <div key={truck.truckId} className="flex flex-col items-center">
            <div className="truck-image-container relative w-44 h-44 sm:w-32 sm:h-32 rounded-md overflow-hidden hover:ring-4 hover:ring-blue-500 transition duration-300">
              <button
