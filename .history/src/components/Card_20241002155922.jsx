    ...
    >
      <div className="p-4">
        <div className="flex justify-between items-start mb-4">
          ...
          <h3 className="text-white font-bold text-lg overflow-hidden whitespace-nowrap text-ellipsis mb-1  max-w-screen-sm">{id}</h3>
          <p className=" text-white text-sm md:text-lg font-semibold overflow-hidden whitespace-normal break max-w-xs">{add}</p>
          </div>
          {imageUrl && (
            <img
              src={imageUrl}
