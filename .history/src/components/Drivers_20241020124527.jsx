              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-start">
                    ...
                    {formData.image ? (
                      <img src={formData.image} alt="Preview" className="w-full h-full mx-5 object-cover rounded-full" />
                    ) : (
                      <div className="w-12 h-12 bg-gray-700 rounded-full flex items-center mx-5 justify-center text-gray-400">
                        <Upload size={24} />
                      </div>
                    )}
