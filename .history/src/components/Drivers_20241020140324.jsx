        ...
        {drivers.map((driver) => (
          ...
          <div key={driver.driverId} className="flex flex-col items-center">
            ...
            <button
              ...
              className="w-full h-full sm:w-24 sm:h-24 rounded-full overflow-hidden hover:ring-4 hover:ring-blue-500 transition duration-300"
            >

              <img src={driver.image} alt={driver.name} className="w-full h-full rounded-md object-cover" />
      ...
      {selectedDriver && (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          ...
          <div className="bg-gray-800 p-8 rounded-lg max-w-md w-full relative">
            ...
            <img src={selectedDriver.image} alt={selectedDriver.name} className="w-full h-full mx-auto mb-4 object-contain" />
