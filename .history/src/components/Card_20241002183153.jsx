          ...
          <AnimatePresence>
            {showMenu && (
              <motion.div
                ...
                className="absolute right-5 top-2 mb-2 w-32 bg-gray-700 rounded-md shadow-lg z-10"
              >
                <button
                  onClick={handleEdit}
                  className="flex items-center w-full px-4 py-2 text-sm text-gray-300 hover:bg-gray-800 hover:border hover:border transition-colors duration-200"
                >
