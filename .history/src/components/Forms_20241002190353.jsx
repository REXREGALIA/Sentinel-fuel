          ...
          <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-600 border-dashed rounded-md">
            <div className="space-y-1 text-center">
              ...
              <div className="flex justify-center text-sm ">
                <label
                  htmlFor="image"
                  className="relative cursor-pointer bg-transparent p-1 rounded-md font-medium text-blue-500 hover:text-blue-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500"
                >
        ...
        {preview && (
          <div className="mt-2">
            <img
              src={preview}
              alt="Preview"
              className="w-full h-full border border-white object-cover rounded-md"
            />
          </div>
        )}
