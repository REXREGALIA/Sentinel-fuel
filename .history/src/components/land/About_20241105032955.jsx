...
const About = forwardRef((props, ref) => (
  <section ref={ref} className="mt-20">
    ...
    <p className="text-gray-400">
      ...
      Our system envisions integrating IoT devices like flow meters and GPS trackers in tankers to monitor fuel
      ...
      drop of fuel reaches its destination securely. 
