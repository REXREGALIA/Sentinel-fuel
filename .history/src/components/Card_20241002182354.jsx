          ...
          <AnimatePresence>
            {showMenu && (
              <motion.div
                ...
                className="absolute right-5 top-2 bottom-full mb-2 w-48 bg-gray-500 rounded-md shadow-lg z-10"
              >
                <button
                  onClick={handleEdit}
                ...
                <button
                  ...
                  className="flex items-center w-full px-4 py-2 text-sm bg-yellow-700 text-red-400 hover:bg-gray-600 transition-colors duration-200"
                >
