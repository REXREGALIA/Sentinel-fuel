...
export default function Component() {
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen flex">
      ...
      >
        <div className="flex items-center justify-center md:justify-between mb-20">
          <div className="flex items-center justify-end">
            {/* <img src={logo} alt="logo" className="w-16 h-20 mr-4" /> */}
            <h1 className="text-xl font-bold">Sentinel Fuel</h1>
          </div>
          <button onClick={toggleSidebar} className="ml-4 flex items-start lg:hidden">
            <RxCross2 size={24} />
          </button>
        </div>

        <div className="flex items-center justify-center md:justify-between mb-20">
  <div className="flex items-center justify-center w-full md:w-auto"> {/* Adjusted width for centering */}
    {/* <img src={logo} alt="logo" className="w-16 h-20 mr-4" /> */}
    <h1 className="text-xl font-bold">Sentinel Fuel</h1>
  </div>
  <button onClick={toggleSidebar} className="ml-4 flex items-start lg:hidden">
