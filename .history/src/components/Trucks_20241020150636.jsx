  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <style jsx global>{`
        ...
        .driver-image-container:hover .truck-icon > svg {
        ...
        {drivers.map((driver) => (
          <div key={driver.driverId} className="flex flex-col items-center">
            <div className="driver-image-container relative w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden hover:ring-4 hover:ring-blue-500 transition duration-300">
              ...
              <div className="truck-icon absolute top-1/2 left-1/2 w-8 h-8 opacity-0 transition-opacity duration-300">
                <Truck size={24} className="text-yellow-500 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
              </div>
            </div>
