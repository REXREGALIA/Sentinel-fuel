      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full rounded-md bg-gray-700 focus:border-blue-500 border-none shadow-none outline-none focus:bg-gray-600 focus:ring-0 text-white"
            required
          />
        </div>
