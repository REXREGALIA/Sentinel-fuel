...
import { X, User, Truck, Settings, LogOut, Fuel, Menu } from "lucide-react";
  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className={`fixed top-0 left-0 bottom-0 w-64 bg-gray-800 dark:bg-gray-900 p-6 flex flex-col z-50 lg:relative lg:translate-x-0 lg:w-64 shadow-xl ${
