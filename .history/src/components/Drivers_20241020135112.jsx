    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      ...
      {selectedDriver && (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          ...
          <div className="bg-gray-800 p-1 rounded-lg max-w-md w-full relative">
            ...
            <img src={selectedDriver.image} alt={selectedDriver.name} className="w-min h-min rounded-md text-center mb-4 object-contain" />
