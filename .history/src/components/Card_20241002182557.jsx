          ...
          <AnimatePresence>
            {showMenu && (
              <motion.div
                ...
                className="absolute right-5 top-2 bottom-full mb-2 w-32 bg-gray-700 rounded-md shadow-lg z-10"
              >
                <button
                  onClick={handleEdit}
                  className="flex items-center w-full px-4 py-2 text-sm bg-yellow-700 text-gray-300 hover:bg-gray-600 transition-colors duration-200"
                >
                ...
                <button
                  ...
                  className="flex items-center w-full px-4 py-2 text-sm bg-yellow-300 text-red-400 hover:bg-gray-600 transition-colors duration-200"
                >
