...
export default function Drivers() {
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div className="bg-gray-800 rounded-lg max-w-md w-full relative shadow-lg max-h-[90vh] overflow-y-auto">
      <button
      ...
      <div className="p-6">
        <h2 className="text-2xl font-bold mb-4 text-center text-white">Add New Driver</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center justify-start">
              ...
              <label
                htmlFor="image"
                className="flex justify-start px-3 py-1 bg-blue-500 text-white rounded-md cursor-pointer hover:bg-blue-600 transition duration-200 text-sm"
              >
                Choose File
              </label>
              {formData.image && (
                <img src={formData.image} alt="Preview" className="ml-2 w-10 h-10 object-cover rounded-full" />
              )}
            </div>
          </div>
          <div className="space-y-1">
          ...
          <button
            type="submit"
            className="w-full py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition duration-300 font-medium"
          >
            Add Driver
          </button>
        </form>
