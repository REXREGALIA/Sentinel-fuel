          ...
          <div className="w-full md:w-1/2 lg:w-2/5">
            <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
              ...
              <div className="text-center mb-10">
                ...
                <p className="text-gray-500">Let's Get Started with FuelFlow</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="button"
                  className="w-full flex items-center justify-center gap-3 px-6 py-3 border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition-colors duration-200"
                >
