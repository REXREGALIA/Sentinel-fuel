...
export default function Trucks() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Create truckData based on locationType
      const truckData = {
      ...
      if (formData.locationType === 'coordinates') {
        ...
        truckData.zipCode = ''; // Empty string instead of undefined
      } else if (formData.locationType === 'zipcode') {
        truckData.zipCode = formData.zipCode;
        truckData.latitude = ''; // Empty string instead of undefined
        truckData.longitude = ''; // Empty string instead of undefined
      }
