...
import { PlusCircle, X, Upload, Truck, Menu, Edit, Trash2 } from 'lucide-react'
          ...
          <div className="min-h-screen bg-gray-900 p-8">
            ...
            {isLoading ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                {trucks.map((truck) => (
                  <div key={truck.id} className="flex flex-col items-center bg-gray-800 p-4 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
                    ...
                    <div className="mt-4 flex space-x-2">
                      <button
                        ...
                        className="p-2 bg-yellow-600 rounded-full hover:bg-yellow-700 transition duration-300"
                      >
                        <Edit size={16} />
                      </button>
                      <button
